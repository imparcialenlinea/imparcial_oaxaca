 ...
 */
$order =  $cat = $offset = $title = $pagination = $thumbnail = '';
$output = $after_output = '';
...
<?php } ?>
		...
		<div class="col-md-4">
			...
			<?php }else{ ?>
			<div class="news-post video-post imgal100">
				<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail($thumbnail); ?></a>
				 <?php if(get_post_format()=='video'){ ?>
				<a href="<?php echo get_post_meta(get_the_ID(), '_hotmagazine_intro_video', true); ?>" class="video-link playgrande"><i class="fa fa-play-circle-o"></i></a>
				<?php } ?>
				<div class="hover-box">
					<h2><a href="<?php the_permalink(); ?>"><?php the_title(); ?> </a></h2>
					<ul class="post-tags">
