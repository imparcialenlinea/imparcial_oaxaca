...
<!--		<div class="post-content">
					...
					<ul class="post-tags">
						<li><i class="fa fa-clock-o"></i><?php the_time(get_option( 'date_format' )); ?></li>
						<?php if($order2<5){ ?>
						<li>lalala<?php comments_popup_link('<i class="fa fa-comments-o"></i><span>0</span> ','<i class="fa fa-comments-o"></i><span>1</span>','<i class="fa fa-comments-o"></i><span>%</span>','comm'); ?></li>
						<?php } ?>
					</ul>
				</div>-->
			</div>
	...
	<div class="owl-carousel" data-num="<?php echo esc_attr($order2); ?>" data-rtl="<?php if ( is_rtl() ) { ?>true<?php }else{  ?>false<?php }?>">
		...
		<?php 
	      ...
	      <?php }else{ ?>
    		...
    		<?php if (in_category('Especiales') or in_category('Videos')) { ?>
...
<li><i class="fa fa-clock-o"></i><?php the_time('M j, Y'); ?></li>		
                ...
                <?php }else{ ?>
                 <?php if (in_category('Cartones')){ ?>
                 <div class="post-content">					
							<h2><a href="<?php the_permalink(); ?>">Cartón de <?php
