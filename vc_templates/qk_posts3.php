...
$arr = array( 'posts_per_page' => $order, 'post_type' => 'post','meta_query' => array(
		array(
...
<?php $id = get_the_ID(); ?>
		...
		<li>
            ...
            <?php 
							...
							<a class="textocategories category-post <?php echo esc_html($cd->slug); ?>" href="<?php echo get_category_link( $cd->term_id ); ?>"><?php echo esc_html($cd->cat_name); ?></a> 
							<?php } ?></div>
				<h2><a href="<?php the_permalink(); ?>"><?php the_title(); ?> </a></h2>
					<ul class="post-tags">
                		<li ><?php esc_html_e('Por ','hotmagazine'); ?> <?php the_author(); ?> </li>
