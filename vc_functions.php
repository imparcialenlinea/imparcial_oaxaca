...
//QK POSTS OPINION POR SECCION 2
if(function_exists('vc_map')){
...
vc_map( array(
   "name" => esc_html__("Posts Opinión por SECCIÓN2","hotmagazine"),
   "base" => "qk_opinion_seccion2",
   "class" => "",
   "category" => esc_html__("Content", "hotmagazine"),
   "icon" => "icon-qk",
   "content_unique" => true,
...
class WPBakeryShortCode_qk_opinion_seccion2 extends WPBakeryShortCode {
}

//FIN POSTS OPINION POR SECCION 2
