...
<div class="search-container-istmo">
	...
	<form method="get" class="search-right" action="<?php echo esc_url( home_url('/') ); ?>" >
		<input class="inputmob-policiaca" type="text" name="s" placeholder="<?php esc_attr_e( ' Escribe aquí tu búsqueda', 'hotmagazine' ); ?>" />
...
<div class="ocultardesktop mob-container mob-card-4 mob-top mob-header-policiaca">
	<div style="display:inline-block; vertical-align:middle; margin-top:3px;" class="mob-top">
       ...
       <div class="menumovil1 menumovdeportes">
		...
		<a  href="/policiaca"><img class="mob-logo" src="https://imparcialoaxaca.mx/wp-content/uploads/2018/07/imparcial-Oaxaca-POLICIACA-nota-roja_mov.png"></a>
		</div>      
...
<!--AQUÍ TERMINA EL HEADER MOVIL-->
			...
			<nav class="navbar navbar-default navbar-static-top ocultarmovil" role="navigation">
				...
				<!-- Top line -->
				<div class="top-line" id="top-line-policiaca">
					<div class="container">
						<div class="row">
							<div class="col-md-9">
							...
							<div class="col-md-3">
								<ul class="social-icons">
									<?php if($custom['facebook']!=''){ ?>
									  <li class="facebook"><a  href="http://www.facebook.com/imparcialpoliciaca"><i class="fa fa-facebook"></i></a></li>
									  <?php } ?>
...
<?php $logomenu='<a class="navbar-brand" href="/policiaca" title="Policiaca | El Imparcial de Oaxaca" style="padding-top: 8px;padding-bottom: 0px;
"><img width="200px" src="https://imparcialoaxaca.mx/wp-content/uploads/2018/07/imparcial-Oaxaca-POLICIACA-nota-roja.png" alt="Súper Deportivo | El Imparcial de Oaxaca"></a>';?>
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								<?php 
									...
									$defaults1= array(
										...
										'container_class' => '',
										'container_id'    => '',
										'menu_class'      => 'nav navbar-nav navbar-left navbar-deportes',
										'menu_id'         => '',
										'echo'            => true,
										 'fallback_cb'       => 'wp_bootstrap_navwalker::fallback',
