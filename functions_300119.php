...
function hotmagazine_setup() {
	...
	add_image_size( 'cartones', 200, 246, true );
	add_image_size( 'principal', 360, 180, array( 'center', 'top')  );	
	add_image_size( 'default', 300, 245, true );
	add_image_size( 'second', 608, 500, true );
...
/*    $cmb = new_cmb2_box( array(
 ...
 /*   if($hotmagazine_options['body_style']!='' and $hotmagazine_options['body_style']=='game' ){
	...
	$group_field_id = $cmb->add_field( array(
	 ...
	 /*    $cmb = new_cmb2_box( array(
        'id'            => 'el_dato',
        'title'         => esc_html__( 'El dato', 'hotmagazine' ),
        'object_types'  => array( 'post', ), // Post type
        'context'       => 'normal',
        'priority'      => 'high',
        'show_names'    => true, // Show field names on the left
	...
	$cmb->add_field( array(
		'name'             => 'Titulo de tabla de datos',
		'id'               => $prefix . 'intertexto',
	    'description' => __( 'Dejar en blanco para que no tenga título', 'cmb2' ),		
		'type'             => 'text',
	...
	$cmb->add_field( array(
		'name'             => 'Tamaño',
		'id'               => $prefix . 'formatointer',
		'type'             => 'select',
		'default'          => 'cajachica',
		'options'          => array(
			'cajachica'   => __( 'Caja chica (default)', 'hotmagazine' ),
			'cajamed'   => __( 'Caja mediana', 'hotmagazine' ),			
			'cajagrande'     => __( 'Caja grande', 'hotmagazine' ),
		),
	) );
	
		$cmb->add_field( array(
		'name'             => 'Mostrar después del párrafo',
		'id'               => $prefix . 'desparraf',
		'type'             => 'select',
		'default'          => '0',
		'options'          => array(
			'0'   => __( '0 (default)', 'hotmagazine' ),
			'1'   => __( '1', 'hotmagazine' ),			
			'2'     => __( '2', 'hotmagazine' ),
			'3'     => __( '3', 'hotmagazine' ),
			'4'     => __( '4', 'hotmagazine' ),
	...
	$cmb->add_field( array(
		...
		'default' => 'outlineblue',	
		'options' => array(
			'outlineblue' => __( 'Azul 1(default)', 'hotmagazine' ),
			'filledblue'   => __( 'Azul 2', 'hotmagazine' ),
			'outlinered'     => __( 'Policiaca 1', 'hotmagazine' ),
			'filledred'     => __( 'Policiaca 2', 'hotmagazine' ),		
	...
	$group_field_id = $cmb->add_field( array(
	    'id'          => 'post_numeralia',
	    'type'        => 'group',
	    'description' => __( 'Ingresa tantos valores como sean necesarios', 'cmb2' ),
	    // 'repeatable'  => false, // use false if you want non-repeatable group
	    'options'     => array(
	        'group_title'   => __( 'Dato {#}', 'cmb2' ), // since version 1.1.4, {#} gets replaced by row number
	        'add_button'    => __( 'Agregar dato', 'cmb2' ),
	        'remove_button' => __( 'Remover dato', 'cmb2' ),
	        'sortable'      => true, // beta
	        // 'closed'     => true, // true to have the groups closed by default
	    ),
	) );
	...
	$cmb->add_group_field( $group_field_id, array(
	    'name' => 'Número',
		'description' => 'Agregar número para los datos',
	    'id'   => $prefix .'numeralia_num',
	    'type' => 'text',
...
/*	    $cmb = new_cmb2_box( array(
        'id'            => 'post_publicidad',
        'title'         => esc_html__( 'Opciones de publicidad', 'hotmagazine' ),
        'object_types'  => array( 'post', ), // Post type
        'context'       => 'normal',
        'priority'      => 'high',
        'show_names'    => true, // Show field names on the left
...
$cmb->add_field( array(
    ...
    'options'          => array(
	    'nopautado'   => __( 'No mandar', 'hotmagazine' ),
        'pautado'   => __( 'Sí', 'hotmagazine' ),
	...
	$cmb->add_field(
     	array(
			    'name' => 'Quitar publicidad intertexto',
			    'desc' => 'Marcar cuando la nota por sí mismo ya sea publicidad',
			    'id' => $prefix . 'publi',
			    'type' => 'checkbox',
			)
     );
	$cmb->add_field(
     	array(
			    'name' => 'Quitar publicidad de DFP',
			    'desc' => ' Quitarla sólo cuando recibimos penalización de Adsense, siempre consultarlo antes',
			    'id' => $prefix . 'publigoogle',
			    'type' => 'checkbox'
			)
     );	 
		*/
 ...
 /*    $cmb = new_cmb2_box( array(
        'id'            => 'post_setting',
        'title'         => esc_html__( 'Resalte', 'hotmagazine' ),
        'object_types'  => array( 'post', ), // Post type
        'context'       => 'normal',
        'priority'      => 'high',
        'show_names'    => true, // Show field names on the left
...
$cmb->add_field( array(
    'name'             => 'Resalte en portada',
    'id'               => $prefix . 'portada',
    'type'             => 'radio_inline',
    'show_option_none' => true,
    'options'          => array(
        'stories'   => __( 'Principal de portada', 'hotmagazine' ),
        'stories2'     => __( 'Secundaria de portada', 'hotmagazine' ),
    ),
) );
...
function custom_equipo_type() {

// Set UI labels for Custom Post Type
	$labels = array(
		'name'                => _x( 'Equipo', 'Post Type General Name', 'twentythirteen' ),
		'singular_name'       => _x( 'Equipo', 'Post Type Singular Name', 'twentythirteen' ),
		'menu_name'           => __( 'Equipos', 'twentythirteen' ),
		'parent_item_colon'   => __( 'Parent equipo', 'twentythirteen' ),
		'all_items'           => __( 'Todos los equipos', 'twentythirteen' ),
		'view_item'           => __( 'Ver equipo', 'twentythirteen' ),
		'add_new_item'        => __( 'Agregar equipo', 'twentythirteen' ),
		'add_new'             => __( 'Agregar nuevo', 'twentythirteen' ),
		'edit_item'           => __( 'Editar equipo', 'twentythirteen' ),
		'update_item'         => __( 'Actualizar equipo', 'twentythirteen' ),
		'search_items'        => __( 'Buscar equipo', 'twentythirteen' ),
...
// Set other options for Custom Post Type
	...
	$args = array(
		'label'               => __( 'Equipos', 'twentythirteen' ),
		'description'         => __( 'Aquí van los equipos', 'twentythirteen' ),
		'labels'              => $labels,
...
add_action( 'init', 'custom_equipo_type', 0 );
...
/*function custom_PDF_type() {

// Set UI labels for Custom Post Type
	$labels = array(
		'name'                => _x( 'PDFs', 'Post Type General Name', 'twentythirteen' ),
		'singular_name'       => _x( 'PDF', 'Post Type Singular Name', 'twentythirteen' ),
		'menu_name'           => __( 'PDFs', 'twentythirteen' ),
		'parent_item_colon'   => __( 'Parent PDF', 'twentythirteen' ),
		'all_items'           => __( 'Todos los PDFs', 'twentythirteen' ),
		'view_item'           => __( 'Ver PDFs', 'twentythirteen' ),
		'add_new_item'        => __( 'Agregar PDF', 'twentythirteen' ),
		'add_new'             => __( 'Agregar PDF', 'twentythirteen' ),
		'edit_item'           => __( 'Editar PDF', 'twentythirteen' ),
		'update_item'         => __( 'Actualizar PDF', 'twentythirteen' ),
		'search_items'        => __( 'Buscar PDF', 'twentythirteen' ),
		'not_found'           => __( 'No encontrado', 'twentythirteen' ),
		'not_found_in_trash'  => __( 'No encontrado en la basura', 'twentythirteen' ),
	);
	*/
...
/*	$args = array(
		'label'               => __( 'PDFs', 'twentythirteen' ),
		'description'         => __( 'Aquí van los PDFs', 'twentythirteen' ),
		'labels'              => $labels,
		'supports'            => array( 'title', 'excerpt', 'thumbnail', 'comments', 'revisions',),
		'taxonomies'          => array( 'publicacion' ),
		'hierarchical'        => true,
		'public'              => true,
		'show_ui'             => true,
		'show_in_menu'        => true,
...
/*add_action( 'init', 'custom_PDF_type', 0 );

function add_publicacion_taxonomies() {
  // Add new "Locations" taxonomy to Posts
  register_taxonomy('publicacion', 'pdf', array(
    // Hierarchical taxonomy (like categories)
    'hierarchical' => true,
    // This array of options controls the labels displayed in the WordPress Admin UI
    'labels' => array(
      'name' => _x( 'Publicaciones', 'taxonomy general name' ),
      'singular_name' => _x( 'Publicacion', 'taxonomy singular name' ),
      'search_items' =>  __( 'Buscar publicaciones' ),
      'all_items' => __( 'Todas las publicaciones' ),
      'parent_item' => __( 'Parent Publicación' ),
      'parent_item_colon' => __( 'Parent Publicación:' ),
      'edit_item' => __( 'Editar Publicación' ),
      'update_item' => __( 'Actualizar Publicación' ),
      'add_new_item' => __( 'Agregar Nueva Publicación' ),
      'new_item_name' => __( 'Nuevo nombre de Publicación' ),
	...
	'sort'     => true,
	      'hierarchical' => true,
    'rewrite' => array(
      'slug' => 'publicacion', // This controls the base slug that will display before each term
      'with_front' => false, // Don't display the category base before "/locations/"

    ),
  ));
}
add_action( 'init', 'add_publicacion_taxonomies', 0 );
    ...
    $meta_boxes[] = array (
      ...
      'fields' =>   array (
        ...
        array (
          ...
          'options' =>       array (
            'noportada' => 'Ninguna',
            'principalstorie' => 'Principal de portada',
            'secundariastorie' => 'Secundaria de portada',
          ),
          'inline' => 1,
          'columns' => 6,
          'tab' => 'resalte',
        ...
        array (
          'id' => 'flag_caducar',
          'type' => 'switch',
          'name' => 'Vigencia de la nota',
          'style' => 'square',
          'on_label' => 'Caducar la nota',
          'off_label' => 'No caducar',
          'columns' => 3,
          'tab' => 'resalte',
          'hidden' =>       array (
            'when' =>         array (
        ...
        array (
          ...
          'options' =>       array (
            'ninguna' => 'Ninguna',
            'almomento' => '#AlMomento',
            'ultimahora' => '#ÚltimaHora',
            'alertavial' => '#AlertaVial',
          ),
          'inline' => 1,
          'columns' => 6,
          'tab' => 'resalte',
        ...
        array (
          'id' => 'pautado',
          'name' => '¿Tiene pauta en redes?',
          'type' => 'radio',
          'desc' => 'Elegir "Indiferente" cuando el contenido de la nota puede funcionar para compartirse en redes. / "Sí, pautar" cuando tiene una pauta especial en redes. / Marcar "No, caducar" cuando la nota NO se debe mandar a redes.',
          'options' =>       array (
        ...
        array (
          ...
          'name' => 'Quitar publicidad intertexto',
          'type' => 'checkbox',
          'desc' => 'Marcar esta casilla quitar la publicidad intertexto (videos) que aparecen entre las notas.',
          'tab' => 'publi_tab',
          'hidden' =>       array (
            'when' =>         array (
        ...
        array (
          'id' => 'fijarstorie',
          'name' => 'Fijar en portada',
          'type' => 'radio',
          'desc' => 'Fija un nota en portada por determinado tiempo',
          'options' =>       array (
            'nofijar' => 'Ninguna',
            'fijarprincipal' => 'Fijar Principal',
            'fijarsecundaria' => 'Fijar Secundaria',
          ),
          'inline' => 1,
          'columns' => 6,
          'tab' => 'publi_tab',
        ...
        array (
          'id' => 'fijartime',
          'name' => '¿Cuánto tiempo fijar?',
          'type' => 'range',
          'desc' => 'Seleccionar tiempo, en horas',
          'min' => 1,
          'max' => 24,
          'step' => 1,
          'columns' => 6,
        ...
        array (
          'id' => 'publiadsense',
          'name' => 'Quitar publicidad de Adsense',
          'type' => 'checkbox',
          'desc' => 'Usar esta opción SOLAMENTE en el caso que se reciba una penalización de Google. Recuerden consultar antes.',
          'tab' => 'publi_tab',
        ),
        ...
        array (
          ...
          'desc' => 'Sube hasta 20 fotos a la galería de fotos',
          'max_file_uploads' => 20,
          'max_status' => 1,
          'tab' => 'multimedia_tab',
        ),
        ...
        array (
          ...
          'type' => 'text',
          'name' => 'Pie de galería',
          'placeholder' => 'Escribe aquí el pie de galería',
          'size' => '100',
          'tab' => 'multimedia_tab',
        ),
      ),
...
//SET POST FORMATS
    ...
    function wpse53235_set_post_format_gallery( $postID ) {
		$images = rwmb_meta( 'gallery_new',array( 'limit' => 1 ),$postID );
		if(empty($images))	
			return;
		$image = reset( $images );
        if ( has_post_format( 'gallery', $postID ) || $image['url']=='')
            return;
        set_post_format( $postID, 'gallery' );
    }	

//SET POST TAGS ACCORDING CATEGORY

    add_action( 'save_post', 'wpse53235_set_post_viral' );
	
    function wpse53235_set_post_viral( $postID ) {
        if ( !has_category( 'Viral', $postID ))
            return;
        wp_set_post_tags( $postID, array( 735 ), true );
    }
	
    add_action( 'save_post', 'wpse53235_set_post_notaroja' );
	
    function wpse53235_set_post_notaroja( $postID ) {
        if ( !has_category( 'Policiaca', $postID ))
            return;
        wp_set_post_tags( $postID, array( 1828 ), true );
    }	
...
//EQUIPOS
function rusia2018_equipos() {

	$args = array (
		'label' => esc_html__( 'Equipos Rusia 2018', 'text-domain' ),
		'labels' => array(
			'menu_name' => esc_html__( 'Equipos Rusia 2018', 'text-domain' ),
			'name_admin_bar' => esc_html__( 'Equipo Rusia 2018', 'text-domain' ),
			'add_new' => esc_html__( 'Agregar nuevo', 'text-domain' ),
			'add_new_item' => esc_html__( 'Agregar nuevo equipo', 'text-domain' ),
			'new_item' => esc_html__( 'Nuevo equipo', 'text-domain' ),
			'edit_item' => esc_html__( 'Editar equipo', 'text-domain' ),
			'view_item' => esc_html__( 'Ver equipo', 'text-domain' ),
			'update_item' => esc_html__( 'Update equipo', 'text-domain' ),
			'all_items' => esc_html__( 'All Equipos Rusia 2018', 'text-domain' ),
			'search_items' => esc_html__( 'Search Equipos Rusia 2018', 'text-domain' ),
			'parent_item_colon' => esc_html__( 'Parent equipo', 'text-domain' ),
			'not_found' => esc_html__( 'No Equipos Rusia 2018 found', 'text-domain' ),
			'not_found_in_trash' => esc_html__( 'No Equipos Rusia 2018 found in Trash', 'text-domain' ),
			'name' => esc_html__( 'Equipos Rusia 2018', 'text-domain' ),
			'singular_name' => esc_html__( 'equipo-mundial', 'text-domain' ),
		),
		'public' => false,
		'exclude_from_search' => true,
		'publicly_queryable' => false,
		...
		'show_in_admin_bar' => false,
		'show_in_rest' => false,
		'menu_icon' => 'http://imparcialoaxaca.mx/wp-content/uploads/2018/05/logotipo_fifa2018_russia-imparcial.png',
		'capability_type' => 'post',
		'hierarchical' => false,
		'has_archive' => false,
		'query_var' => true,
	...
	register_post_type( 'equipo-mundial', $args );
}
add_action( 'init', 'rusia2018_equipos' );

//FIN EQUIPOS

//GRUPOS
function grupos_rusia2018() {

	$args = array (
		'label' => esc_html__( 'Grupos', 'text-domain' ),
		'labels' => array(
			'menu_name' => esc_html__( 'Grupos', 'text-domain' ),
			'all_items' => esc_html__( 'Todos los Grupos', 'text-domain' ),
			'edit_item' => esc_html__( 'Editar grupo', 'text-domain' ),
			'view_item' => esc_html__( 'Ver grupo', 'text-domain' ),
			'update_item' => esc_html__( 'Actualizar grupo', 'text-domain' ),
			'add_new_item' => esc_html__( 'Agregar nuevo grupo', 'text-domain' ),
			'new_item_name' => esc_html__( 'Nuevo grupo', 'text-domain' ),
			'parent_item' => esc_html__( 'Parent grupo', 'text-domain' ),
			'parent_item_colon' => esc_html__( 'Parent grupo:', 'text-domain' ),
			'search_items' => esc_html__( 'Search Grupos', 'text-domain' ),
			'popular_items' => esc_html__( 'Popular Grupos', 'text-domain' ),
			'separate_items_with_commas' => esc_html__( 'Separate Grupos with commas', 'text-domain' ),
			'add_or_remove_items' => esc_html__( 'Add or remove Grupos', 'text-domain' ),
			'choose_from_most_used' => esc_html__( 'Choose most used Grupos', 'text-domain' ),
			'not_found' => esc_html__( 'No Grupos found', 'text-domain' ),
			'name' => esc_html__( 'Grupos', 'text-domain' ),
			'singular_name' => esc_html__( 'grupo', 'text-domain' ),
		),
		'public' => false,
		'show_ui' => false,
		'show_in_menu' => false,
	...
	register_taxonomy( 'grupo', array( 'equipo-mundial' ), $args );
}
add_action( 'init', 'grupos_rusia2018', 0 );
//FIN GRUPOS
...
//PARTIDOS RUSIA 2018
function Partidos_Rusia2018() {

	$args = array (
		'label' => esc_html__( 'Partidos', 'text-domain' ),
		'labels' => array(
			'menu_name' => esc_html__( 'Partidos Rusia 2018', 'text-domain' ),
			'name_admin_bar' => esc_html__( 'partido', 'text-domain' ),
			'add_new' => esc_html__( 'Agregar nuevo', 'text-domain' ),
			'add_new_item' => esc_html__( 'Agregar nuevo partido', 'text-domain' ),
			'new_item' => esc_html__( 'Nuevo partido', 'text-domain' ),
			'edit_item' => esc_html__( 'Editar partido', 'text-domain' ),
			'view_item' => esc_html__( 'Ver partido', 'text-domain' ),
			'update_item' => esc_html__( 'Update partido', 'text-domain' ),
			'all_items' => esc_html__( 'Todos los Partidos', 'text-domain' ),
			'search_items' => esc_html__( 'Search Partidos', 'text-domain' ),
			'parent_item_colon' => esc_html__( 'Parent partido', 'text-domain' ),
			'not_found' => esc_html__( 'No Partidos found', 'text-domain' ),
			'not_found_in_trash' => esc_html__( 'No Partidos found in Trash', 'text-domain' ),
			'name' => esc_html__( 'Partidos', 'text-domain' ),
			'singular_name' => esc_html__( 'partido', 'text-domain' ),
		),
		'public' => false,
...
add_action( 'init', 'Partidos_Rusia2018' );

//FIN PARTIDOS RUSIA 2018

//ESTADIOS RUSIA

function estadios_rusia2018() {

	$args = array (
		'label' => esc_html__( 'Estadios', 'text-domain' ),
		'labels' => array(
			'menu_name' => esc_html__( 'Estadios', 'text-domain' ),
			'all_items' => esc_html__( 'All Estadios', 'text-domain' ),
			'edit_item' => esc_html__( 'Edit estadio', 'text-domain' ),
			'view_item' => esc_html__( 'View estadio', 'text-domain' ),
			'update_item' => esc_html__( 'Update estadio', 'text-domain' ),
			'add_new_item' => esc_html__( 'Add new estadio', 'text-domain' ),
			'new_item_name' => esc_html__( 'New estadio', 'text-domain' ),
			'parent_item' => esc_html__( 'Parent estadio', 'text-domain' ),
			'parent_item_colon' => esc_html__( 'Parent estadio:', 'text-domain' ),
			'search_items' => esc_html__( 'Search Estadios', 'text-domain' ),
			'popular_items' => esc_html__( 'Popular Estadios', 'text-domain' ),
			'separate_items_with_commas' => esc_html__( 'Separate Estadios with commas', 'text-domain' ),
			'add_or_remove_items' => esc_html__( 'Add or remove Estadios', 'text-domain' ),
			'choose_from_most_used' => esc_html__( 'Choose most used Estadios', 'text-domain' ),
			'not_found' => esc_html__( 'No Estadios found', 'text-domain' ),
			'name' => esc_html__( 'Estadios', 'text-domain' ),
			'singular_name' => esc_html__( 'estadio', 'text-domain' ),
		),
		'public' => false,
		'show_ui' => false,
		'show_in_menu' => false,
	...
	register_taxonomy( 'estadio', array( 'partido' ), $args );
}
add_action( 'init', 'estadios_rusia2018', 0 );
