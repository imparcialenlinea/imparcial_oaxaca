					...
					<div class="col-sm-8 content-blocker">
						...
						<div class="block-content">
							...
							<div class="grid-box">
								...
								<?php }elseif (is_search()) { ?>
									<div class="title-section">
									<h2>Resultados para "<?php echo esc_attr( get_search_query() ); ?>"</h2>
								</div>
								<?php }elseif (is_tag()) { ?>
								<div class="title-section linea-capital">
								<h2><?php single_tag_title( '', true ); ?></h2>
								</div>
								<?php }elseif (is_tax( 'ubicaciones' )) { ?>
								<div class="title-section linea-capital">
								<?php $cd=single_tag_title( '', false ); ?>
								<h2>Noticias de <?php echo ($cd); ?></h2>
								</div>
<iframe
  width="100%"
  height="300"
  frameborder="0" style="border:0"
  src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCbdw5b2mlHMeJemwgMbSg6BZBa7OawnMg&q=<?php echo (str_replace(' ','+', $cd))?>" allowfullscreen>
</iframe><div class="vc_empty_space" style="height: 32px"><span class="vc_empty_space_inner"></span></div>
						...
						<div class="news-post article-post">		
							<div class="row">
								...
								<?php else: ?>
								<div class="not-found">
									<h1><?php esc_html_e('No se encontró nada','hotmagazine'); ?></h1>
									<h3><?php esc_html_e('Intenta otra combinación de palabras', 'hotmagazine') ?></h3>
									<div class="search-form">
										<?php get_search_form(); ?>
									</div>
								</div>
							...
							<!-- pagination box -->
							<div class="pagination-box">
								<?php hotmagazine_pagination($prev = esc_html__('Anterior', 'hotmagazine'), $next = esc_html__('Siguiente', 'hotmagazine'), $pages=''); ?>
					...
					<div class="col-sm-4 sidebar-sticky">
						...
						<div class="vc_empty_space" style="height: 32px"><span class="vc_empty_space_inner"></span></div><?php get_sidebar(); ?>
