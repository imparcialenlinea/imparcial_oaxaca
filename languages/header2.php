<?php $custom  = hotmagazine_custom(); ?>
		...
		<header class="clearfix  second-style ">
			...
			<nav class="navbar navbar-default navbar-static-top" role="navigation">
								...
								<ul class="social-icons">
									<?php if($custom['facebook']!=''){ ?>
									 ...
									 <?php if($custom['istagram']!=''){ ?>
										<li class="instagram"><a  target="blank"  href="<?php echo esc_url($custom['istagram']); ?>"><i class="fa fa-instagram"> </i></a></li>
										<?php } ?>
									  <?php if($custom['google']!=''){ ?>
									  <li class="google"><a  target="blank"   href="<?php echo esc_url($custom['google']); ?>"><i class="fa fa-google-plus"></i></a></li>
									  <?php } ?>
									  <?php if($custom['linkedin']!=''){ ?>
									  <li class="linkedin"><a  target="blank"   href="<?php echo esc_url($custom['linkedin']); ?>"><i class="fa fa-youtube-play"></i></a></li>
									  <?php } ?>
									  <?php if($custom['pinterest']!=''){ ?>
									  <li class="pinterest" ><a  target="blank"  href="<?php echo esc_url($custom['pinterest']); ?>"><i class="fa fa-pinterest"></i></a></li>
									  <?php } ?>
								</ul>
							</div>	
						</div>
				...
				<?php } ?>
				<!-- Logo & advertisement -->
				<div class="logo-advertisement ocultar">
					<div class="container">
