...
<!--AQUÍ TERMINA EL HEADER MOVIL-->
            ...
            <script type="text/javascript">window.onload = date_time('date_time');</script></li>
							...
							<div class="col-md-3">
								<ul class="social-icons">
									<?php if($custom['facebook']!=''){ ?>
									  <li class="facebook"><a  href="https://www.facebook.com/imparcialoaxaca"><i class="fa fa-facebook"></i></a></li>
									  <?php } ?>
									  <?php if($custom['twitter']!=''){ ?>
									  <li class="twitter"><a href="https://www.twitter.com/imparcialoaxaca"><i class="fa fa-twitter"></i></a></li>
									  <?php } ?>
				...
				<!-- End Top line -->
				<?php } ?>
                <?php if(is_page( 3618 )){ //MINIMENU DE SECCIONES INTERIORES, NO HOME?>
				<!-- Logo & advertisement -->
                ...
                <?php $logomenu=''; }else{ $logomenu='<a class="navbar-brand" href="/costa" title="El Imparcial de la Costa" style="padding-top: 8px;padding-bottom: 0px;
"><img src="https://imparcialoaxaca.mx/wp-content/uploads/2017/02/logo-imparcial_de_la_costa_2017.png" width="180px" alt="El Imparcial de la Costa"></a>';?>
