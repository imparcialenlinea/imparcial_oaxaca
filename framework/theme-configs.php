    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'type' => 'media',
                'url' => true,
                'title' => esc_html__('Logo para Desktop (Oaxaca)', 'hotmagazine'),
                'compiler' => 'true',
                //'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                'desc' => esc_html__('Subir logo para Desktop.', 'hotmagazine'),
                'subtitle' => '',
			...
			array(
                ...
                'type' => 'media',
                'url' => true,
                'title' => esc_html__('Logo para móvil', 'hotmagazine'),
                'compiler' => 'true',
                //'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                'desc' => esc_html__('Subir acá logo para móvil  (Oaxaca).', 'hotmagazine'),
                'subtitle' => '',
                'default' => array('url' => get_template_directory_uri().'/images/logo.png'),
            ),
			 array(
                ...
                'type' => 'media',
                'url' => true,
                'title' => esc_html__('Logo para Desktop (Istmo)', 'hotmagazine'),
                'compiler' => 'true',
                //'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                'desc' => esc_html__('Subir logo para Desktop.', 'hotmagazine'),
                'subtitle' => '',
			 ...
			 array(
                ...
                'type' => 'media',
                'url' => true,
                'title' => esc_html__('Logo para movil(istmo)', 'hotmagazine'),
                'compiler' => 'true',
                //'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                'desc' => esc_html__('Subir logo para movil.', 'hotmagazine'),
                'subtitle' => '',
                'default' => array('url' => get_template_directory_uri().'/images/logo.png'),
            ),array(
                'id' => 'logocosta',
                'type' => 'media',
                'url' => true,
                'title' => esc_html__('Logo para Desktop (Costa)', 'hotmagazine'),
                'compiler' => 'true',
                //'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                'desc' => esc_html__('Subir logo para Desktop.', 'hotmagazine'),
                'subtitle' => '',
			 ...
			 array(
                ...
                'type' => 'media',
                'url' => true,
                'title' => esc_html__('Logo para movil(Costa)', 'hotmagazine'),
                'compiler' => 'true',
                //'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                'desc' => esc_html__('Subir logo para movil.', 'hotmagazine'),
                'subtitle' => '',
                ...
                'type' => 'media',
                'url' => true,
                'title' => esc_html__('Logo para Desktop (Cuenca)', 'hotmagazine'),
                'compiler' => 'true',
                //'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                'desc' => esc_html__('Subir logo para Desktop.', 'hotmagazine'),
                'subtitle' => '',
			 ...
			 array(
                ...
                'type' => 'media',
                'url' => true,
                'title' => esc_html__('Logo para movil(Cuenca)', 'hotmagazine'),
                'compiler' => 'true',
                //'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                'desc' => esc_html__('Subir logo para movil.', 'hotmagazine'),
                'subtitle' => '',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'id' => 'instagram',
                'type' => 'text',
                'title' => esc_html__('Instagram Url', 'hotmagazine'),
                //'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
            ...
            array(
                'id' => 'youtube',
                'type' => 'text',
                'title' => esc_html__('Youtube Url', 'hotmagazine'),
                //'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
            ...
            array(
                'id' => 'soundcloud',
                'type' => 'text',
                'title' => esc_html__('Soundcloud Url', 'hotmagazine'),
                //'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                'default' => '#'
            ),
        )
