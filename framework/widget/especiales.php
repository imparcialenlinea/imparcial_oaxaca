...
// Creating the widget 
class especiales_post_widget extends WP_Widget {

function __construct() {

parent::__construct(
// Base ID of your widget
'especiales_post_widget', 

// Widget name will appear in UI
esc_html__('QK Especiales Posts', 'hotmagazine'), 

// Widget description
array( 'description' => esc_html__( 'Listing Especiales Posts', 'hotmagazine' ), ) 
);
}
...
<p>
<label for="<?php echo esc_attr($this->get_field_id( 'cat' )); ?>"><?php esc_html_e( 'Categoría:', 'hotmagazine'); ?></label> 
<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'cat' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'cat' )); ?>" type="text" value="<?php echo esc_attr( $cat ); ?>" />
</p>
<p>
...
function wpb_load_widget_especiales() {
	register_widget( 'especiales_post_widget' );
}
add_action( 'widgets_init', 'wpb_load_widget_especiales' );
?>