						...
						<div class="block-content">
							...
							<div class="grid-box">
								<div class="title-section">
									<h1><span><?php esc_html_e('Notas por autor','hotmagazine'); ?></span></h1>
								</div>
										...
										<div class="autor-box">
											...
											<div class="autor-content">
												...
												<div class="autor-title">
													<h1><span><?php echo esc_html($curauth->display_name); ?></span><a href="#"><?php echo count_user_posts( $curauth->ID , 'post' ); ?> <?php echo esc_html('Notas', 'magazine'); ?></a></h1>
