...
$cmb->add_field( array(
    'name'             => 'Resalte',
	'desc'             => 'Elige la vigencia del resalte en portada de acuerdo al tiempo de validez de la nota."Todo el día" mantiene la nota en portada durante todo el día; "Default" dura 4 horas, "Mediodía" dura 8 horas y "Pronto" dura 2 horas.' ,	
    'id'               => 'portada',
    'type'             => 'radio_inline',
    'show_admin_column' => true,	
    'show_option_none' => true,
    'options'          => array(
		'4'   => __( 'Default', 'hotmagazine' ),		
		'24'   => __( 'Todo el día', 'hotmagazine' ),		
        '8'   => __( 'Mediodía', 'hotmagazine' ),
		'2'   => __( 'Pronto', 'hotmagazine' ),	      
    ),
) );	
$cmb->add_field( array(
    'name'             => 'Etiqueta',
	'desc'             => 'Si la nota es especial, elegir la etiqueta correspondiente, Elegir alguna de las otras opciones sólo coloca una "banderita" extra cuando van en portada' ,		
    'id'               => 'especial',
    'type'             => 'radio_inline',
    'show_option_none' => true,
    'options'          => array(
        '1'   => __( 'Especial', 'hotmagazine' ),
...
$cmb->add_field( array(
	'name'             => 'Datos extras',
	'desc'             => 'Seleccionar los que apliquen',
	'id'               => 'hoy',
	'type'             => 'multicheck',
	'options'          => array(		
		'c' => __( 'Caducar', 'cmb2' ),
		't' => __( 'Ticker', 'cmb2' ),		
		'espubli' => __( 'Publicidad', 'cmb2' ),
		),
) );
    $cmb = new_cmb2_box( array(
        'id'            => 'post_options',
...
*/    $cmb = new_cmb2_box( array(
    ...
    $cmb->add_field(
    	array(	'name'    => esc_html__( 'Avatar', 'hotmagazine' ),
    ...
    $cmb->add_field(
    	array(	'name'     => esc_html__( 'Facebook', 'hotmagazine' ),
 	...
 	$cmb->add_field(   	
		array(	'name'     => esc_html__( 'Google', 'hotmagazine' ),
     ...
     $cmb->add_field(
    	array(	'name'     => esc_html__( 'Twitter', 'hotmagazine' ),
      ...
      $cmb->add_field(
    	array(	'name'     => esc_html__( 'Youtube', 'hotmagazine' ),
       ...
       $cmb->add_field(
    	array(	'name'     => esc_html__( 'Linkedin', 'hotmagazine' ),
        ...
        $cmb->add_field(
    	array(	'name'     => esc_html__( 'Instagram', 'hotmagazine' ),
         ...
         $cmb->add_field(
    	array(	'name'     => esc_html__( 'Columna', 'hotmagazine' ),
	         ...
	         $cmb->add_field(
    	array(	'name'     => esc_html__( 'Ubicación default', 'hotmagazine' ),
...
function wpdocs_posts_thumb_columns( $columns ) {
    $post_new_columns = array(
       'post_thumbs' => esc_html__( 'Imagen', 'text_domain' ),
    );
