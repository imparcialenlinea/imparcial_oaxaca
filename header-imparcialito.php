...
<!--AQUÍ TERMINA EL HEADER MOVIL-->
			...
			<nav class="navbar navbar-default navbar-static-top ocultarmovil" role="navigation">
				...
				<!-- Top line -->
				<div class="top-line" id="top-line-imparcialito">
					<div class="container">
						<div class="row">
							<div class="col-md-9">
            ...
            <script type="text/javascript">window.onload = date_time('date_time');</script></li>
				...
				<!-- Logo & advertisement -->
				<div class="logo-advertisement" style="background-image: url(http://imparcialito.com/wp-content/uploads/sites/4/2018/09/background-imparcialito-repeat.jpg);">
					<div class="container">
						<div class="navbar-header">
							...
							<a class="navbar-brand"  href="<?php echo esc_url(home_url('/istmo')); ?>" title="El Imparcial del Istmo">
								<?php if($custom['logoistmo']['url']!=''){ ?>
									<img src="http://imparcialito.com/wp-content/uploads/sites/4/2018/09/imparcialOAX-imparcialito_logotipo.png" alt="El Imparcial del Istmo">
								  <?php }else{ ?>
									<?php bloginfo('name'); ?>
								  <?php } ?>
							</a>
